        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-md leading-relaxed">
              Discover the world responsibly with our sustainable travel experiences. 
              Join us for unforgettable adventures that protect and preserve our planet&apos;s natural wonders.
            </p>
