...
const Hero: React.FC<HeroProps> = ({ 
  ...
  const renderContent = () => {
    ...
    return (
      <div className={`flex-1 flex flex-col justify-center py-12 ${paddingClasses.horizontal}`}>
        {/* Top Padding Spacer */}
  ...
  if (layout === "fullBackground" || (!layout && !image?.url)) {
    return (
      <section 
        className={`relative h-[50vh] min-h-[400px] flex items-center justify-center ${colorClasses?.bg || ''}`}
        style={{
        ...
        <div className="relative z-10 text-center">
          <div className="container mx-auto">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className={`max-w-4xl mx-auto ${paddingClasses.horizontal}`}>
          {/* Top Padding Spacer */}
          <div className={paddingClasses.top}></div>
